    ...
    public function checks(): array
    {
        return [
            new ControlAccountCheck(
                ...
                sumber: 'Faktur pelanggan, dikurangi pembayaran, nota kredit dan giro yang dipegang',
            ),
            new ControlAccountCheck(
            ...
            new ControlAccountCheck(
                ...
                subledger: $this->receivables->giroHeld(null),
                sumber: 'Nilai bilyet giro pelanggan yang belum cair atau ditolak',
            ),
            new ControlAccountCheck(
                kode: AccountCode::UTANG_GIRO,
                nama: 'Utang Giro',
                buku: $this->ledger->balanceOf(AccountCode::UTANG_GIRO),
                subledger: $this->suppliers->giroIssued(),
                sumber: 'Nilai bilyet giro kita yang belum dicairkan pemasok',
            ),
            new ControlAccountCheck(
