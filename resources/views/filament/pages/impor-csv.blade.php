    ...
    @else
        ...
        <div class="rounded-xl border border-gray-200 bg-white dark:border-white/10 dark:bg-gray-900">
                            ...
                            <tr @class([
                                ...
                                <td class="px-3 py-2">
                                    <span @class([
                                        ...
                                        'bg-success-100 text-success-700 dark:bg-success-500/20 dark:text-success-300' => ! $row->tertahan(),
            ...
            <p class="border-t border-gray-100 px-3 py-2 text-xs text-gray-500 dark:border-white/5 dark:text-gray-400">
                ...
                yang sudah tersimpan tidak akan terduplikasi, karena kunci yang sama ditahan.
            </p>
        </div>
    @endif
