{{--
    ...
    Deliberately the same layout as impor-pelanggan: the two imports are one
    idea, and a person who has used one should recognise the other on sight.
--}}
    ...
    @if ($this->rows() === [])
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-900">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                ...
                barang itu, bukan membuat yang kedua. Satu berkas boleh berisi seluruh katalog.
            </p>

            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Tidak ada kolom <span class="font-mono text-xs">HARGA</span> di sini, dan berkas
                yang membawanya akan ditolak: harga hanya berubah lewat
                <strong>Impor harga &amp; barang</strong>, yang menerbitkan versi daftar harga baru.
            </p>
                            ...
                            <tr @class([
                                ...
                                <td class="px-3 py-2">
                                    <span @class([
                                        ...
                                        'bg-success-100 text-success-700 dark:bg-success-500/20 dark:text-success-300' => $row->status === \App\Domain\Import\ProductImportRow::BARU,
                                        'bg-primary-100 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' => $row->status === \App\Domain\Import\ProductImportRow::PERBARUI,
