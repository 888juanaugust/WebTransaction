...
@section('deskripsi', config('perusahaan.ringkasan'))
...
@section('konten')
    ...
    <section class="border-b border-slate-100 bg-gradient-to-b from-brand-50 to-white">
        <div class="mx-auto max-w-6xl px-4 py-20 sm:py-28">
            ...
            <p class="mt-8 text-sm text-slate-500">
                Kami melayani <strong class="font-semibold text-slate-700">bengkel, toko sparepart,
                dan distributor</strong>. Harga grosir hanya tersedia untuk pelanggan terdaftar.
            </p>
        </div>
    </section>
    ...
    <section class="mx-auto max-w-6xl px-4 py-20">
        ...
        <div class="mt-6 max-w-3xl space-y-4">
            @foreach (array_slice(config('perusahaan.profil'), 0, 2) as $paragraf)
    ...
    <section class="mx-auto max-w-6xl px-4 py-20">
        ...
        <p class="mt-8 text-sm text-slate-500">
            Daftar produk lengkap beserta harga tersedia bagi pelanggan terdaftar setelah masuk.
        </p>
    </section>
    ...
    <section class="border-t border-slate-100 bg-slate-50">
        <div class="mx-auto max-w-6xl px-4 py-16">
            <h2 class="text-2xl font-bold tracking-tight text-slate-900">Mitra kerja sama</h2>
            <p class="mt-2 max-w-2xl text-slate-600">
                Kami bekerja sama dengan sejumlah perusahaan untuk menjaga pasokan dan jangkauan pengiriman.
            </p>
    ...
    <section class="mx-auto max-w-6xl px-4 py-20">
        <div class="rounded-2xl bg-brand-600 px-8 py-12 text-center">
            <h2 class="text-2xl font-bold text-white">Sudah menjadi pelanggan kami?</h2>
            <p class="mx-auto mt-3 max-w-xl text-brand-100">
                Masuk untuk melihat harga Anda, sisa limit kredit, faktur, dan riwayat pesanan.
            </p>
            <a href="{{ route('masuk') }}"
